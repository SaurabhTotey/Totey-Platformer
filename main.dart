...
void main() {
    ...
    final crapTestLevel = new Level(width: 3200, height: 1800, startingPosition: [0, 1600], entities: [new SolidPlatform(0, 1700, 800, 50), new SolidPlatform(800, 1600, 800, 50), new SolidPlatform(1600, 1500, 800, 50), new CheckPointGrave(1975, 1425), new SolidPlatform(2400, 1400, 400, 50), new EndBlock(3100, 1200), new ItemBlock(375, 1500), new ItemBlock(1175, 1400, new CheckPointGrave(1175, 1325))], drawables: [new Drawable(0, 0, 3200, 1800, bg: const Color(135, 206, 250))]);
